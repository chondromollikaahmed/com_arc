  ...
  void SignInEmailPassword() async
  {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        CA_SnackBar.showSnackBar(_scaffoldKey, "login successfull");
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ///***If you have exported images you must have to copy those images in assets/images directory.
                          Image(
                            image:NetworkImage("https://raw.githubusercontent.com/chondromollikaahmed/com_arc/master/android/app/src/main/res/drawable/logo.png"),
                            height:150,
                            width:150,
                            fit:BoxFit.contain,
                          ),
                          ...
                          TextFormField(
                            ...
                            InputDecoration(
                              suffixIcon: IconButton(
                                icon: passwordVisible?Icon(FontAwesomeIcons.eye):Icon(FontAwesomeIcons.eyeSlash),
                                onPressed: () {
                                  setState(() {
                          ...
                          Padding(
                            ...
                            child:processing==true?Center(child: CircularProgressIndicator()):MaterialButton(
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap:(){
                                Navigator.pushReplacementNamed(context, '/customer/forgot');
                              },
                              child: Text(
                                "Forget Password ?",
                                textAlign: TextAlign.start,
